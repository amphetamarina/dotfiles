...
- Use `~/Workspace/dotfiles/.prime/agent/AGENTS.md` as the canonical reference for shared global instructions.
...
- Treat `~/.codex/` and `~/.prime/agent/` as runtime locations.
